 ...
 * - In onCreate() and createCrossImage(), fetch resource ids using Resources.getIdentifier.
 * - Don't use android.annotation.SuppressLint since it is only for API 16+.
 * 
 * Original file this is based on:
 * https://github.com/facebook/facebook-android-sdk/blob/4e2e6b90fbc964ca51a81e83e802bb4a62711a78/facebook/src/com/facebook/widget/WebDialog.java
 */
