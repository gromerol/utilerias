...
public final class BumpResources
{
    ...
    public BumpResources() {
    	BumpResources.APP_PACKAGE_NAME = TiApplication.getInstance().getPackageName();
    }

    public final static Resources getResources() {
    	return TiApplication.getAppRootOrCurrentActivity().getResources();
    }
