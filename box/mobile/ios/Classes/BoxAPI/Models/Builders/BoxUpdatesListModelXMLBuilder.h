...
@property (retain) BoxUpdate *currentUpdate;
@property (retain) NSMutableDictionary *currentUpdateAttributes;
@property (retain) NSMutableArray *updatesList;
@property (retain) BoxObject *boxObject;
