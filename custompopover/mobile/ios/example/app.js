//Example lifted from the iPad popover kitchen sink example.

var win = Ti.UI.createWindow();
win.open();

Popover = {};
Popover.view = Ti.UI.createView({backgroundColor:'yellow'});

var popoverSource = require("ti.custompopover");
...
Popover.init = function()
{
	...
	b1.addEventListener('click', function()
	{
		...
		var popover = popoverSource.createPopover({ 
			width:200, 
			height:350,
			title:'Table View',
